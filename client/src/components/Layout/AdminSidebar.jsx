...
export default function AdminSidebar() {
  const items = [
    ...
    nav('/admin/announcements', 'announcements', 'Announcements'),
    nav('/admin/users', 'users', 'Users'),
    nav('/admin/rooms', 'rooms', 'Rooms'),
    nav('/admin/allotments', 'allotments', 'Allotments'),
    nav('/admin/fees', 'fees', 'Fees'),
    nav('/admin/complaints', 'complaints', 'Complaints'),
  ...
  return (
    <aside className="w-[240px] min-h-screen flex flex-col shrink-0 bg-[#1e2329]">
      <div className="p-5 flex items-center gap-2">
        ...
        <span className="px-2 py-0.5 rounded text-[10px] font-medium bg-amber-500/30 text-amber-400">Admin</span>
      </div>
