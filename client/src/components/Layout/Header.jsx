...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between h-14 px-6 bg-white border-b border-gray-200">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded bg-emerald-500 flex items-center justify-center text-white font-bold text-xs">
            HL
          </div>
          <span className="font-semibold text-gray-900">{panelLabel} Panel</span>
        ...
        <div className="relative ml-2">
          ...
          {showMenu && (
            <>
              ...
              <div className="absolute right-0 top-full mt-2 w-48 py-2 bg-white rounded-lg shadow-xl border border-gray-100 z-50">
